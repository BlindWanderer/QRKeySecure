...
import java.util.*;
/**
 * A class that provides basic Decoding functionality for a QRCode
 * Works on a "cleaned" boolean matrix, that is generated by the Reader.
 *
 */
public class Decoder {
	...
	/**
	 * Provides a visual representation of a boolean matrix, where each value maps to a black or white module.
	 * @param matrix boolean[][] that contains information
	 * @return BufferedImage representation of the matrix
	 */
	...
	/**
	 * Decodes a boolean[][] according to decoding rules outlined in QRCode specs.
	 * @param cleanMatrix
	 * @param swp a designated worker thread
	 * @return object - decoded data (text String or byte[])
	 */
